...
import { changePassSchema, signInSchema, signUpSchema } from "../schemas/auth.schema.js";
...
authRouter.post("/change", authorizeUser, validate(changePassSchema), changePass);
